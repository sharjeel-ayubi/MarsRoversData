...
@MainActor
class OpportunityPhotoListViewModel: ObservableObject {
    ...
    init(repository: any PhotosRepositoryProtocol = OpportunityRepository(request: OpportunityPhotosRequest())) {
