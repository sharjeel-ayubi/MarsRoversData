//
//  OpportunityPhotoListView.swift
...
struct OpportunityPhotoListView: View {
    
    @StateObject var viewModel = OpportunityPhotoListViewModel()
...
struct OpportunityPhotoListView_Previews: PreviewProvider {
